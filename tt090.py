...
class MyApp:
    def __init__(self, parent):
        ...
        ### Out topmost frame is called myContainer1
        ...
        # buttons frame
        self.buttons_frame = Tkinter.Frame(self.myContainer1) ###
        ...
        # top frame
        self.top_frame = Tkinter.Frame(self.myContainer1)
        ...
        # bottom frame
        self.bottom_frame = Tkinter.Frame(self.myContainer1,
            borderwidth=5,  relief=Tkinter.RIDGE,
            height=50,
            background="white"
            ) ###
        ...
        # left_frame
        self.left_frame = Tkinter.Frame(self.top_frame, background="red",
            borderwidth=5,  relief=Tkinter.RIDGE,
            height=250,
            width=50
            ) ###
        ...
        ### right_frame
        self.right_frame = Tkinter.Frame(self.top_frame, background="tan",
            borderwidth=5, relief=Tkinter.RIDGE,
            width=250
            )
        ...
        self.button1 = Tkinter.Button(self.buttons_frame, command=self.button1Click)
        ...
        self.button2 = Tkinter.Button(self.buttons_frame, command=self.button2Click)
